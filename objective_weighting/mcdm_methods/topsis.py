...
class TOPSIS(MCDM_method):
    def __init__(self, normalization_method = minmax_normalization):
        ...
        ------
            normalization_method : function
                Method for normalization of decision matrix chosen `normalization_method` from `normalizations`.
    ...
    def _topsis(matrix, weights, types, normalization_method):
        ...
        # Calculate chosen distance of every alternative from PIS (dp) and NIS (dm)
